# Generated by Django 2.1.1 on 2018-09-30 16:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(choices=[('Sample', 'Sample'), ('SampleTag', 'Sample Tag'), ('Location', 'Location'), ('LocationTag', 'Location Tag')], default='Sample', max_length=55)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(choices=[('add', 'Add objects'), ('edit', 'Edit objects'), ('delete', 'Remove Objects'), ('view', 'View objects')], max_length=55)),
