# Generated by Django 2.1.1 on 2018-10-08 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', lims.models.LimsModelField(choices=[('Sample', 'Sample'), ('SampleTag', 'Sample Tag'), ('Attachment', 'Attachment'), ('AttachmentTag', 'Attachment Tag'), ('Term', 'Term'), ('TermTag', 'Term Tag')], max_length=55)),
        ...
        migrations.AddField(
            model_name='attachment',
            name='term_tags',
            field=models.ManyToManyField(blank=True, related_name='attachments', to='lims.TermTag'),
        ),
        migrations.AddField(
            model_name='attachment',
            name='terms',
