# Generated by Django 2.1.1 on 2018-10-07 03:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', lims.models.LimsModelField(choices=[('Sample', 'Sample'), ('SampleTag', 'Sample Tag'), ('Location', 'Location'), ('LocationTag', 'Location Tag'), ('Attachment', 'Attachment'), ('AttachmentTag', 'Attachment Tag')], max_length=55)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_ymin', models.FloatField(blank=True, default=None, editable=False, null=True)),
                ('geo_ymax', models.FloatField(blank=True, default=None, editable=False, null=True)),
                ('name', models.CharField(default='location', max_length=55)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='samples', to='lims.Location')),
        ...
        migrations.AddField(
            ...
            name='key',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='location_tags', to='lims.Term'),
        ),
        migrations.AddField(
            model_name='locationtag',
            name='object',
        ...
        migrations.AddField(
            model_name='locationtag',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='lims_location_tags', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='location',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='locations', to='lims.Project'),
        ),
        migrations.AddField(
            model_name='location',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='lims_locations', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
